...
RSpec.describe StockEntry, type: :model do
  ...
  it "without product" do
    stock_entry = build(:stock_entry, product: nil)
    expect(stock_entry).to be_invalid
  end

  it "without entry_date" do
    stock_entry = build(:stock_entry, entry_date: nil, product: @product)
    expect(stock_entry).to be_invalid
  end

  it "wihtout responsible" do
    stock_entry = build(:stock_entry, responsible: nil, product: @product)
    expect(stock_entry).to be_invalid
  end
